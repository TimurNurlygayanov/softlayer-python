        ...
        if (result.data && result.data.length > 0) {
          ...
          return $(function() {
            ...
            $.each(repos, function(i, repo) {
              ...
              pushDelta = void 0;
              weekHalfLife = void 0;
              weightForPush = void 0;
              weightForWatchers = void 0;
...
(function() {
  ...
  $.ajax({
    ...
    success: function(json) {
      ...
      return $("#title-milestones").text(lastMilestone.title);
    }
  });
  ...
  $.ajax({
    ...
    dataType: "jsonp",
    success: function(json) {
      var stamp, stampString;
      stamp = new Date(lastCommit.commit.committer.date);
      stampString = month[stamp.getMonth()] + " " + stamp.getDate();
      return $("#date-commits").text(stampString);
    }
  });
  ...
  $.ajax({
    ...
    success: function(json) {
      var lastTag;
      lastTag = json.data[0];
      return $("#version-tags").text(lastTag.name);
    }
  });
